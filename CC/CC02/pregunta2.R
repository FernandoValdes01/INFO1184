...
# Datos: X = [23.11, -3.33, 1.30, 29.20, -1.57, 34.10, -8.90, -3.40, 9.09, 3.03]
# Norma L1 (Manhattan)
# ============================================================
...
# ============================================================
# a) Dendrograma basico (method = "single" por defecto para L1)
# ============================================================
hc_single <- hclust(d, method = "single")

png("/home/claude/dendro_basico.png", width = 900, height = 600, res = 120)
...
# --- k=2 ---
png("/home/claude/dendro_k2.png", width = 900, height = 600, res = 120)
...
# --- k=3 ---
png("/home/claude/dendro_k3.png", width = 900, height = 600, res = 120)
...
# 1) Single Linkage
png("/home/claude/dendro_single.png", width = 900, height = 600, res = 120)
...
# 2) Complete Linkage
png("/home/claude/dendro_complete.png", width = 900, height = 600, res = 120)
...
# 3) Average Linkage
png("/home/claude/dendro_average.png", width = 900, height = 600, res = 120)
...
png("/home/claude/dendro_comparacion.png", width = 1200, height = 500, res = 120)
...
cat("\nScript ejecutado exitosamente. Imagenes guardadas.\n")
