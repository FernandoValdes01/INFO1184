...
A continuación, se presenta de forma complementaria el dashboard generado en Power BI (Figura~\ref{fig:dashboard}), el cual permite visualizar de manera integrada las principales variables del dataset y su relación con el rendimiento de arroz.

A partir del análisis visual del dashboard, se observa que el conjunto de datos está compuesto por 2.789 parcelas distribuidas en seis bloques agrícolas, con un rendimiento promedio de 22.518~Kg. La distribución por variedad es relativamente equilibrada entre CO\_43, delux ponni y ponmani.

En la relación entre hectáreas y rendimiento, se aprecia una tendencia positiva clara: las parcelas de mayor escala presentan mayores rendimientos absolutos, lo cual es consistente con los perfiles de clusters identificados en el análisis por k-medias.

Respecto a los bloques agrícolas, se observan diferencias en el rendimiento promedio entre regiones, lo que sugiere la influencia de las condiciones climáticas locales (humedad, temperatura, precipitación) en la productividad.

En conjunto, estos hallazgos complementan los resultados del clustering al confirmar visualmente que la escala productiva y la ubicación geográfica son factores determinantes del rendimiento, facilitando la comunicación de resultados a actores no técnicos del sector agrícola.
...
% TODO: Reemplazar 'dashboard_powerbi.pdf' con el nombre real de la captura del dashboard
\begin{figure}[H]
\centering
\includegraphics[width=1\textwidth]{dashboard_powerbi.pdf}
...
\begin{table}[H]
  ...
  \begin{tabularx}{\textwidth}{l X l}
    ...
    13-04-2026 & Construcción del dashboard interactivo en Power BI Desktop: importación del dataset, creación de tarjetas KPI, gráficos de barras por bloque agrícola, gráfico circular de variedades, mapa de calor rendimiento--variedad--suelo y segmentadores interactivos. & Vicente Rivera \\
